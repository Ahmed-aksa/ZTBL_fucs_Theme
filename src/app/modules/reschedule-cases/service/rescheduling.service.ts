...
export class ReschedulingService {
    ...
    GetRescheduling(res, branch, zone): Observable<BaseResponseModel> {
        ...
        return this.http
            .post(`${environment.apiUrl}/Loan/GetRescheduling`, this.request, {
                headers: this.httpUtils.getHTTPHeaders(),
            })
            .pipe(map((res: BaseResponseModel) => res));
    }

    SaveMakeRescheduleLoan(
        res: MakeReschedule,
        branch,
        zone
        ...
        return this.http
            .post(
                `${environment.apiUrl}/Loan/SaveMakeRescheduleLoan`,
                this.request,
                { headers: this.httpUtils.getHTTPHeaders() }
            )
            .pipe(map((res: BaseResponseModel) => res));
    ...
    SubmitRescheduleData(
        rescheduling: MakeReschedule,
        branch,
        zone
    ): Observable<BaseResponseModel> {
        this.request = new BaseRequestModel();
        ...
        return this.http
            .post(
                `${environment.apiUrl}/Loan/SubmitRescheduleData`,
                this.request,
                { headers: this.httpUtils.getHTTPHeaders() }
            )
            .pipe(map((res: BaseResponseModel) => res));
    ...
    CancelRescheduleData(
        ...
        return this.http
            .post(
                `${environment.apiUrl}/Loan/CancelRescheduleData`,
                this.request,
                { headers: this.httpUtils.getHTTPHeaders() }
            )
            .pipe(map((res: BaseResponseModel) => res));
    ...
    GetDisbursementByGl(id): Observable<BaseResponseModel> {
        ...
        return this.http
            .post(
                `${environment.apiUrl}/Loan/GetDisbursementByGl`,
                this.request,
                { headers: this.httpUtils.getHTTPHeaders() }
            )
            .pipe(map((res: BaseResponseModel) => res));
    ...
    AddReschedulLoanInstallment(res): Observable<BaseResponseModel> {
        ...
        return this.http
            .post(
                `${environment.apiUrl}/Loan/AddReschedulLoanInstallment`,
                this.request,
                { headers: this.httpUtils.getHTTPHeaders() }
            )
            .pipe(map((res: BaseResponseModel) => res));
    ...
    RescheduleSearch(search, branch, zone): Observable<BaseResponseModel> {
        ...
        var req = JSON.stringify(this.request);
        return this.http
            .post(`${environment.apiUrl}/Loan/RescheduleSearch`, this.request, {
                headers: this.httpUtils.getHTTPHeaders(),
            })
            .pipe(map((res: BaseResponseModel) => res));
    }
    ...
    GetSubProposalGL(lCNo, branch, zone): Observable<BaseResponseModel> {
        ...
        this.request.Zone = zone;
        return this.http
            .post(`${environment.apiUrl}/Loan/GetSubProposalGL`, this.request, {
                headers: this.httpUtils.getHTTPHeaders(),
            })
            .pipe(map((res: BaseResponseModel) => res));
    }

    GetReshTransactionByID(
        loanReschID,
        zone,
        branch
    ): Observable<BaseResponseModel> {
        ...
        return this.http
            .post(
                `${environment.apiUrl}/Loan/GetReshTransactionByID`,
                this.request,
                { headers: this.httpUtils.getHTTPHeaders() }
            )
            .pipe(map((res: BaseResponseModel) => res));
