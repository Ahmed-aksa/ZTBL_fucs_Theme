...
export class NewGlCodeComponent implements OnInit {
    ...
    getGlCode() {
        ...
        this._loanService.SearchGLCode(this.glConfigrationsDetail, this.parent_data.branch, this.parent_data.zone)
            .pipe(
                finalize(() => {
                    this.spinner.hide();
                })
    ...
    find() {
        ...
        this._loanService.SearchGLCode(this.glConfigrationsDetail, this.parent_data?.zone, this.parent_data?.branch)
            .pipe(
                finalize(() => {
                    this.spinner.hide();
                })
