...
@Component({
    selector: 'create-tour-plan-zc',
    templateUrl: './create-tour-plan-zc.component.html',
    styleUrls: ['./create-tour-plan-zc.component.scss'],
})
export class CreateTourPlanZCComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        this.currentActivity = this.userUtilsService.getActivity('Create Tour Plan For ZC')
        this.createForm();
    ...
    SearchTourPlan(startDate, endDate) {
        ...
        this.tourPlanService.GetScheduleBaseTourPlan(TourPlan, count, currentIndex, this.branch, this.zone, 'ZC')
            .pipe(
                finalize(() => {
                    this.spinner.hide();
                })
    ...
    deleteTourPlan(item) {
        ...
        dialogRef.afterClosed().subscribe((data) => {
            if (data) {
                ...
                this.tourPlanService
                    .ChanageTourStatus(this.TourPlan, 'ZC')
                    .pipe(finalize(() => {
                        this.spinner.hide();
                    }))
                    .subscribe(
    ...
    submitTourPlan() {
        ...
        dialogRef.afterClosed().subscribe((data) => {
            if (data) {
                ...
                this.tourPlanService
                    .ChanageTourStatusMultiple(this.tourPlanSubmit, 'ZC')
                    .pipe(finalize(() => {
                        this.spinner.hide();
                    }))
                    .subscribe(
