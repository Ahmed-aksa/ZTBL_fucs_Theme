...
@Component({
    selector: 'create-tour-plan-bm',
    templateUrl: './create-tour-plan-bm.component.html',
    styleUrls: ['./create-tour-plan-bm.component.scss'],
})
export class CreateTourPlanBmComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        this.currentActivity = this.userUtilsService.getActivity('Create Tour Plan For BM')
        this.createForm();
    ...
    AddCal() {
        ...
        this.tourPlanService
            .createTourPlan(this.TourPlan, this.zone, this.branch, this.circle, this.startDate, this.endDate, "BM")
            .pipe(finalize(() => {
                this.spinner.hide();
            }))
            .subscribe(
    ...
    SearchTourPlan(startDate, endDate) {
        ...
        this.tourPlanService.GetScheduleBaseTourPlan(TourPlan, count, currentIndex, this.branch, this.zone, 'BM')
            .pipe(
                finalize(() => {
                    this.spinner.hide();
                })
    ...
    deleteTourPlan(item) {
        ...
        dialogRef.afterClosed().subscribe((data) => {
            if (data) {
                ...
                this.tourPlanService
                    .ChanageTourStatus(this.TourPlan, 'BM')
                    .pipe(finalize(() => {
                        this.spinner.hide();
                    }))
                    .subscribe(
    ...
    submitTourPlan() {
        ...
        dialogRef.afterClosed().subscribe((data) => {
            if (data) {
                ...
                this.tourPlanService
                    .ChanageTourStatusMultiple(this.tourPlanSubmit, 'BM')
                    .pipe(finalize(() => {
                        this.spinner.hide();
                    }))
                    .subscribe(
