...
export class CreateTourPlanPcComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        this.currentActivity = this.userUtilsService.getActivity('Create Tour Plan For PC')
        this.createForm();
    ...
    SearchTourPlan(startDate, endDate) {
        ...
        this.tourPlanService.GetScheduleBaseTourPlan(TourPlan, count, currentIndex, this.branch, this.zone, 'PC')
            .pipe(
                finalize(() => {
                    this.spinner.hide();
                })
    ...
    deleteTourPlan(item) {
        ...
        dialogRef.afterClosed().subscribe((data) => {
            if (data) {
                ...
                this.tourPlanService
                    .ChanageTourStatus(this.TourPlan, 'PC')
                    .pipe(finalize(() => {
                        this.spinner.hide();
                    }))
                    .subscribe(
    ...
    submitTourPlan() {
        ...
        dialogRef.afterClosed().subscribe((data) => {
            if (data) {
                ...
                this.tourPlanService
                    .ChanageTourStatusMultiple(this.tourPlanSubmit, 'PC')
                    .pipe(finalize(() => {
                        this.spinner.hide();
                    }))
                    .subscribe(
