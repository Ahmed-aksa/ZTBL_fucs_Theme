...
@Component({
    selector: 'create-tour-plan-zm',
    templateUrl: './create-tour-plan-zm.component.html',
    styleUrls: ['./create-tour-plan-zm.component.scss'],
})
export class CreateTourPlanZmComponent implements OnInit, OnDestroy {
    ...
    SearchTourPlan(startDate, endDate) {
        ...
        this.tourPlanService.GetScheduleBaseTourPlan(TourPlan, count, currentIndex, this.branch, this.zone, 'ZM')
            .pipe(
                finalize(() => {
                    this.spinner.hide();
                })
    ...
    deleteTourPlan(item) {
        ...
        dialogRef.afterClosed().subscribe((data) => {
            if (data) {
                ...
                this.tourPlanService
                    .ChanageTourStatus(this.TourPlan, 'ZM')
                    .pipe(finalize(() => {
                        this.spinner.hide();
                    }))
                    .subscribe(
    ...
    submitTourPlan() {
        ...
        dialogRef.afterClosed().subscribe((data) => {
            if (data) {
                ...
                this.tourPlanService
                    .ChanageTourStatusMultiple(this.tourPlanSubmit, 'ZM')
                    .pipe(finalize(() => {
                        this.spinner.hide();
                    }))
                    .subscribe(
