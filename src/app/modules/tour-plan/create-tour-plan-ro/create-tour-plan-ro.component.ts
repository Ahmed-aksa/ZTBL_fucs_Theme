...
@Component({
    selector: 'create-tour-plan-ro',
    templateUrl: './create-tour-plan-ro.component.html',
    styleUrls: ['./create-tour-plan-ro.component.scss'],
})
export class CreateTourPlanRoComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        this.currentActivity = this.userUtilsService.getActivity('Create Tour Plan For RO')
        this.createForm();
    ...
    SearchTourPlan(startDate, endDate) {
        ...
        this.tourPlanService.GetScheduleBaseTourPlan(TourPlan, count, currentIndex, this.branch, this.zone, 'RO')
            .pipe(
                finalize(() => {
                    this.spinner.hide();
                })
    ...
    deleteTourPlan(item) {
        ...
        dialogRef.afterClosed().subscribe((data) => {
            if (data) {
                ...
                this.tourPlanService
                    .ChanageTourStatus(this.TourPlan, 'RO')
                    .pipe(finalize(() => {
                        this.spinner.hide();
                    }))
                    .subscribe(
    ...
    submitTourPlan() {
        ...
        dialogRef.afterClosed().subscribe((data) => {
            if (data) {
                ...
                this.tourPlanService
                    .ChanageTourStatusMultiple(this.tourPlanSubmit, 'RO')
                    .pipe(finalize(() => {
                        this.spinner.hide();
                    }))
                    .subscribe(
