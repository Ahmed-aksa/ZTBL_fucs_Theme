...
@Component({
    selector: 'create-tour-plan-rc',
    templateUrl: './create-tour-plan-rc.component.html',
    styleUrls: ['./create-tour-plan-rc.component.scss'],
})
export class CreateTourPlanRcComponent implements OnInit, OnDestroy {
    ...
    ngOnInit(): void {
        this.currentActivity = this.userUtilsService.getActivity('Create Tour Plan For RC')
        this.createForm();
    ...
    AddCal() {
        ...
        this.tourPlanService
            .createTourPlan(this.TourPlan, this.zone, this.branch, this.circle, this.startDate, this.endDate,"RC")
            .pipe(finalize(() => {
                this.spinner.hide();
            }))
            .subscribe(
