...
@Component({
    selector: 'app-affidavit-for-legal-heirs',
    templateUrl: './affidavit-for-legal-heirs.component.html',
    styleUrls: ['./affidavit-for-legal-heirs.component.scss'],
    providers: [
        DatePipe,
...
export class AffidavitForLegalHeirsComponent implements OnInit {
