...
@Component({
    selector: 'app-loan-account-balance',
    templateUrl: './loan-account-balance.component.html',
    styleUrls: ['./loan-account-balance.component.scss'],
    providers: [
        DatePipe,
...
export class LoanAccountBalanceComponent implements OnInit {
