...
@Component({
	...
	templateUrl: './assign-pages-edit.dialog.component.html',
	changeDetection: ChangeDetectionStrategy.Default,
})
export class AssignPageEditDialogComponent implements OnInit, OnDestroy {
	// Public properties
	role: Role;
	 ...
	 *
	 * @param dialogRef: MatDialogRef<AssignPageEditDialogComponent>
	 * @param data: any
	 * @param store: Store<AppState>
	 */
	constructor(public dialogRef: MatDialogRef<AssignPageEditDialogComponent>,
