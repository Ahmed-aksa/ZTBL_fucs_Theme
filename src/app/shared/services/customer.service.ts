...
export class CustomerService {
  ...
  createCustomerSave(customer: CreateCustomer): Observable<BaseResponseModel> {
    ...
    return this.http.post(`${environment.apiUrl}/Customer/CreateCustomer`, this.request,
  ...
  getCustomerInfo(request: BaseRequestModel): Observable<BaseResponseModel> {
    ...
    return this.http.post(`${environment.apiUrl}/Customer/GetCustomerInfo`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  }
  ...
  submitNdc(customer: CreateCustomer): Observable<BaseResponseModel> {
    ...
    return this.http.post(`${environment.apiUrl}/Customer/SubmitNDC`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  }
  ...
  addCustomerInfo(customer: CreateCustomer): Observable<BaseResponseModel> {
    ...
    return this.http.post(`${environment.apiUrl}/Customer/AddCustomerInfo`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  }
  ...
  refreshEcib(customer: CreateCustomer): Observable<BaseResponseModel> {
    ...
    return this.http.post(`${environment.apiUrl}/Customer/RefreshECIB`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  }
  ...
  submitDocument(formData: any): Observable<BaseResponseModel> {
    ...
    return this.http.post(`${environment.apiUrl}/Document/SubmitDocument`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  }
  ...
  searchCustomer_bkp(customer: CreateCustomer): Observable<BaseResponseModel> {
    ...
    return this.http.post(`${environment.apiUrl}/Customer/SearchCustomer`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  }
  ...
  GetCustomer(customer: CreateCustomer): Observable<BaseResponseModel> {
    ...
    return this.http.post(`${environment.apiUrl}/Customer/GetCustomerDetail`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  }
