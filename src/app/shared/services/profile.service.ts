...
export class ProfileService {
    ...
    updateProfile(profile, profileID = -1): Observable<BaseResponseModel> {
        ...
        return this.http.post(`${environment.apiUrl}/Activity/AddPagesWithRoleMapping`, this.request,
    ...
    getRoleGroups() {
        ...
        return this.http.post(`${environment.apiUrl}/Profile/GetRoleGroups`, this.request,
            {headers: this.httpUtils.getHTTPHeaders()}).pipe(
            map((res: BaseResponseModel) => res)
        );
    ...
    AddNewRole(profile: Profile): Observable<BaseResponseModel> {
        ...
        return this.http.post(`${environment.apiUrl}/Profile/AddRole`, this.request).pipe(
            map((res: BaseResponseModel) => res)
        );
    }
    ...
    UpdateRole(profile: Profile): Observable<BaseResponseModel> {
        ...
        return this.http.post(`${environment.apiUrl}/Profile/UpdateRole`, this.request,
            {headers: this.httpUtils.getHTTPHeaders()}).pipe(
            map((res: BaseResponseModel) => res)
        );
    }
