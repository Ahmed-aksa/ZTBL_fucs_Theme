...
import { AppraisalProposed, CorporateSurety, CropProduction, CurrentLoans, CustomersLoanApp, CustomersLoanLand, GlConfigrationsDetail, Loan, LoanApplicationHeader, LoanApplicationPurpose, LoanDbr, LoanDocumentCheckList, LoanDocuments, LoanPastPaid, LoanRefrences, LoanSecurities, LoanWitness, ORR, PersonalSureties, SearchLoan, SearchLoanDbr } from '../models/Loan.model';
...
export class LoanService {
  ...
  saveApplicationHeader(loanReq: LoanApplicationHeader): Observable<BaseResponseModel>{
    ...
    return this.http.post(`${environment.apiUrl}/Loan/SaveApplicationHeader`, this.request,
  ...
  saveLoanApplicationPurpose(loanReq: LoanApplicationPurpose, tranId: number): Observable<BaseResponseModel> {
    ...
    return this.http.post(`${environment.apiUrl}/Loan/SaveLoanApplicationpurpose`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  }
  ...
  generateNewAutoLc(branch: Branch) {
    ...
    var req = JSON.stringify(this.request);
    return this.http.post(`${environment.apiUrl}/Loan/GenrateNewLc`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  }
  ...
  getCustomerLand(loanAppId) {
    ...
    var req = JSON.stringify(this.request);
    return this.http.post(`${environment.apiUrl}/Loan/GetLoanLand`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  saveLoanSecurities(securitiesReq: LoanSecurities, tranId: number) {
    ...
    var req = JSON.stringify(this.request);
    debugger
    return this.http.post(`${environment.apiUrl}/Loan/SaveLoanSecurities`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  saveCustomerWithLoanApp(customerLoanReq: CustomersLoanApp, tranId : number) {
    ...
    var req = JSON.stringify(this.request);
    debugger
    return this.http.post(`${environment.apiUrl}/Loan/SaveCustomerWithLoanApp`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  }
  ...
  saveLoanApplicationLegalHeirs(legalheirsReq: LoanApplicationLegalHeirs, tranId: number, loanId: number) {
    ...
    var req = JSON.stringify(this.request);
    debugger
    return this.http.post(`${environment.apiUrl}/Loan/SaveLoanApplicationLegalheirs`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  saveUpdatePersonalSureties(personalSureties: PersonalSureties, tranId: number) {
    ...
    var req = JSON.stringify(this.request);
    debugger
    return this.http.post(`${environment.apiUrl}/Loan/SaveUpdatePersonalSureties`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  saveUpdateCorporateSurety(corporateSurety: CorporateSurety, tranId: number) {
    ...
    var req = JSON.stringify(this.request);
    debugger
    return this.http.post(`${environment.apiUrl}/Loan/Saveupdatecorporatesurety`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  saveUpdateReferences(loanRefrences: LoanRefrences, tranId: number) {
    ...
    var req = JSON.stringify(this.request);
    debugger
    return this.http.post(`${environment.apiUrl}/Loan/SaveupdateReferences`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  SaveUpdateWitnesses(loanWitness: LoanWitness, tranId: number) {
    ...
    var req = JSON.stringify(this.request);
    debugger
    return this.http.post(`${environment.apiUrl}/Loan/SaveupdateWitnesses`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  SaveUpdatePastPaidLoans(loanPastPaid: LoanPastPaid, tranId: number) {
    ...
    var req = JSON.stringify(this.request);
    debugger
    return this.http.post(`${environment.apiUrl}/Loan/SaveupdatePastPaidLoans`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  getDocumentNo(TranId: any) {
    ...
    return this.http.post(`${environment.apiUrl}/Loan/GetDocumentNo`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  getCheckList(loanReq: LoanApplicationHeader, tranId: number) {
    ...
    return this.http.post(`${environment.apiUrl}/Loan/GetCheckList`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  saveCheckList(loanReq: LoanDocumentCheckList[], tranId: number) {
    ...
    return this.http.post(`${environment.apiUrl}/Loan/SaveCheckList`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  submitLoanApplication(loanReq: LoanApplicationHeader, tranId: number) {
    ...
    return this.http.post(`${environment.apiUrl}/Loan/SubmitLoanApplication`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  saveUpdateCurrentLoans(loanReq: CurrentLoans, tranId: number) {
    ...
    return this.http.post(`${environment.apiUrl}/Loan/SaveupdateCurrentLoans`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  attachCustomersLand(customerLandList: CustomersLoanLand[], tranId: number) {
    ...
    return this.http.post(`${environment.apiUrl}/Loan/AttachCustomersLand`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  }
  ...
  SearchGLCode(loanReq: GlConfigrationsDetail) {
    ...
    return this.http.post(`${environment.apiUrl}/Loan/SearchGLCode`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  addCropDetail(cropProd: CropProduction, tranId: number) {
    ...
    return this.http.post(`${environment.apiUrl}/Loan/AddCropDetail`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  }
  ...
  addAppraisalProposed(appraisalList: AppraisalProposed[], tranId: number) {
    ...
    return this.http.post(`${environment.apiUrl}/Loan/AddAppraisalProposed`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  }
  ...
  getORRDropDownByAppID(loanAppID:string) {
    ...
    return this.http.post(`${environment.apiUrl}/Loan/GetORRDropDownByAppID`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  deleteAppraisalItemDetail(appraisal: AppraisalProposed, tranId: number) {
    ...
    this.request.Activity = this.activity;
      ...
      return this.http.post(`${environment.apiUrl}/Loan/DeleteAppraisalItemDetail`, this.request,
          { headers: this.httpUtils.getHTTPHeaders() }).pipe(
              map((res: BaseResponseModel) => res)
          );
  }
...
//  }
  ...
  GetViewLoanDocument(app) {
    ...
    var req = JSON.stringify(this.request);
    debugger
    return this.http.post(`${environment.apiUrl}/Recovery/GetViewLoanDocument`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
    );
  ...
  searchLoanApplication(loanFilter: SearchLoan) {
    ...
    return this.http.post(`${environment.apiUrl}/Loan/SearchLoanApplication`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  saveLoanDbr(dbrReq: LoanDbr, tranId: number) {
    ...
    return this.http.post(`${environment.apiUrl}/Loan/SaveDBR`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  searchLoanDbr(loanFilter: SearchLoanDbr) {
    ...
    return this.http.post(`${environment.apiUrl}/Loan/GetDBR`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  deleteCustomerLoanApplication(custLoanAppId) {
    ...
    return this.http.post(`${environment.apiUrl}/Loan/DeleteCustomerLoanApplication`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  deletePurposeLoanApplication(custLoanAppId) {
    ...
    return this.http.post(`${environment.apiUrl}/Loan/DeleteLoanpurpose`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
...
var req
    ...
    return this.http.post(`${environment.apiUrl}/Loan/DocumentDelete`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  ...
  deleteLegalHeirs(legalId, loan) {
    ...
    return this.http.post(`${environment.apiUrl}/Loan/DeleteLegalHeirs`, this.request,
      { headers: this.httpUtils.getHTTPHeaders() }).pipe(
        map((res: BaseResponseModel) => res)
      );
  }
